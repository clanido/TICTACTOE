-- schema.sql
-- One-table database schema for the Tic-Tac-Toe Swing project.
-- Default target: MySQL. See notes at the bottom for PostgreSQL / SQL Server.
...
-- Sample users for testing the login feature.
